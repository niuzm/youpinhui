...
public class GoodsController {
	...
	public Result update(@RequestBody Goods goods){
		String sellerId = SecurityContextHolder.getContext().getAuthentication().getName();
		Goods originGoods = goodsService.findOne(goods.getGoods().getId());
		if(!goods.getGoods().getSellerId().equals(sellerId) || !originGoods.getGoods().getSellerId().equals(sellerId)) {
